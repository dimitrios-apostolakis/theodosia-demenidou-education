...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative overflow-hidden pt-6 sm:pt-8 pb-10 sm:pb-16 bg-gradient-to-b from-yellow-100/60 via-amber-50/40 to-transparent w-full max-w-full">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-amber-200/70 border border-amber-300 text-amber-900 text-xs sm:text-sm font-bold shadow-xs mb-4 sm:mb-6 animate-bounce-soft max-w-full">
          <Heart className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-rose-500 fill-rose-500 shrink-0" />
          <span className="truncate">Καλώς ήρθατε στην εκπαιδευτική φωλιά της <strong>Θεοδοσίας Δεμενίδου</strong>!</span>
        ...
        <div className="max-w-2xl mx-auto relative mb-4 sm:mb-6">
          <div className="relative flex items-center shadow-md rounded-3xl bg-white border-2 sm:border-3 border-yellow-300 focus-within:border-amber-400 focus-within:ring-4 focus-within:ring-yellow-200/60 transition-all p-1.5 sm:p-2">
            <div className="pl-2 sm:pl-3 pr-1 sm:pr-2 text-amber-500">
            ...
            <div className="pr-1 sm:pr-2 shrink-0">
              <span className="inline-flex items-center px-2 sm:px-3 py-1 rounded-2xl bg-amber-100 text-amber-800 text-[10px] sm:text-xs font-bold">
        ...
        <div className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 text-[11px] sm:text-sm font-bold text-slate-600">
          <span className="text-amber-700 flex items-center gap-1">
            <Sparkles className="w-3 h-3 text-amber-500" /> Δημοφιλή:
          </span>
          {popularTags.map((tag) => (
            <button
              key={tag}
              ...
              className="px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full bg-white/90 hover:bg-yellow-200 text-slate-700 border border-yellow-200 shadow-2xs hover:scale-105 transition-all active:scale-95 text-[11px] sm:text-xs"
            >
              #{tag}
            </button>
          ))}
        ...
        <div className="mt-8 sm:mt-10 grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-3 max-w-4xl mx-auto">
          <div className="p-2.5 sm:p-3 bg-white/80 backdrop-blur-xs rounded-2xl border border-yellow-200 shadow-2xs flex items-center justify-center gap-1.5 text-slate-700 font-bold text-xs sm:text-sm">
            <span className="text-base sm:text-xl">🖨️</span> Εκτύπωση A4
          </div>
          <div className="p-2.5 sm:p-3 bg-white/80 backdrop-blur-xs rounded-2xl border border-blue-200 shadow-2xs flex items-center justify-center gap-1.5 text-slate-700 font-bold text-xs sm:text-sm">
            <span className="text-base sm:text-xl">🎒</span> 6 Τάξεις
          </div>
          <div className="p-2.5 sm:p-3 bg-white/80 backdrop-blur-xs rounded-2xl border border-purple-200 shadow-2xs flex items-center justify-center gap-1.5 text-slate-700 font-bold text-xs sm:text-sm">
            <span className="text-base sm:text-xl">🍌</span> Nano Banana AI
          </div>
          <div className="p-2.5 sm:p-3 bg-white/80 backdrop-blur-xs rounded-2xl border border-emerald-200 shadow-2xs flex items-center justify-center gap-1.5 text-slate-700 font-bold text-xs sm:text-sm">
